...
setwd('H:\\PHD_database\\Paper_writing\\A_Paper_XVIII_BreastCancer_LXN_ver2\\Step7_OtherGSE\\Chr2_GSE103091_ConsenseCluster')
...
dir.create(paste0('limma.dir.5gene.',method))
title=paste0(pathway,'/limma.dir.5gene.',method)
...
save(tmp_df,file = 'GSE103091_tmp_group_5genes.RData')
...
tiffFile=paste0('GSE103091',"_SurvivalOS_5genes.pdf")
